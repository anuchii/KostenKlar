...
VALUES
  (
    ...
    'Doe',
    'john.doe@email.com',
    '$2y$10$tx/wQcYyWzUp/4MPUtKMoOqTm.Ex4DzdIit4giK99T0FeaWgOsnJK',
    'user',
    'active'
  ),
  (
    ...
    '$2y$10$.NpIELMYHUrZJWShkm48cuNOoztuBbjXACSwGGJMFb0lZdX8AxZxS',
    'user',
    'active'
  ),
  (
    ...
    'Max',
    'Mustermann',
    'm.mustermann@test.at',
    '$2y$10$4LYst5.Joxr8E4Sb.Cn9mOo5Wf0eAB4uulobbVAZgNVMUsL.gQvBK',
    'user',
    'active'
  );
...
--
ALTER TABLE `transactions` MODIFY `transaction_id` int (10) UNSIGNED NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 2;
...
--
ALTER TABLE `transactions` ADD CONSTRAINT `transactions_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`),

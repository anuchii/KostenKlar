                ...
                <div class="row align-items-center g-4">
                    <div class="col-12 col-lg-6">
                        ...
                        <p class="lead text-muted mt-3 mb-4">
                            KostenKlar hilft dir, Transaktionen zu erfassen, Statistiken zu sehen und deine Finanzen
                            besser zu verstehen.
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <a class="btn btn-outline-secondary btn-lg" href="<?= page_url('login') ?>">Ich habe schon
                                einen Account</a>
                        </div>
                        <div class="d-flex gap-4 mt-4 text-muted small">
                            <div class="d-flex align-items-center gap-2"><i class="bi bi-shield-check"></i> Intuitiv
                            </div>
                            <div class="d-flex align-items-center gap-2"><i class="bi bi-lightning-charge"></i> In
                                Minuten startklar</div>
                            <div class="d-flex align-items-center gap-2"><i class="bi bi-graph-up"></i> Klarer Überblick
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-6">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="card shadow-sm border-0 h-100">
                            <div class="card-body p-4">
                                ...
                                <p class="text-muted mb-0">Einnahmen & Ausgaben schnell eintragen und kategorisieren.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="card shadow-sm border-0 h-100">
                            <div class="card-body p-4">
                                ...
                                <p class="text-muted mb-0">Sieh, wo dein Geld hingeht – klare Auswertungen statt Chaos.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="card shadow-sm border-0 h-100">
                            <div class="card-body p-4">
                                ...
                                <p class="text-muted mb-0">Profilbild hochladen, Daten bearbeiten und alles aktuell
                                    halten.</p>
                            </div>
                        </div>
                    </div>

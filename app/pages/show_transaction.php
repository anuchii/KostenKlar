                            ...
                            <div class="card shadow-sm rounded-3">
                                ...
                                <div class="card-body p-0">
                                    <table class="table table-striped align-middle mb-0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="fw-semibold <?= ($transaction['transaction_type'] === 'expense') ? 'text-danger' : 'text-success' ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge <?= ($transaction['transaction_type'] === 'revenue') ? 'bg-success' : 'bg-danger' ?>">
                                    ...
                                    <div class="d-flex gap-2 p-3">
                                        ...
                                        <form
                                            action="<?= route('delete_transaction', ['transaction-id' => $transaction['transaction_id']]) ?>"
                                            method="post" onsubmit="return confirm('Eintrag wirklich löschen?');">
                                            <input type="hidden" name="transaction-id"
                                                value="<?= (int) $transaction['transaction_id'] ?>">

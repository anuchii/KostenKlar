<form method="post" action="<?= $postAction ?>">
    ...
    <div class="mb-3">
        ...
        <input type="text"
            ...
            id="first-name" name="first_name" value="<?php echo htmlspecialchars($userData["first_name"] ?? '') ?>">
        <?php
    ...
    <div class="mb-3">
        ...
        <input type="text"
            ...
            id="first-name" name="last_name" value="<?php echo htmlspecialchars($userData["last_name"] ?? '') ?>">
        <?php
    ...
    <div class="mb-3">
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="status" id="expense" value="active"
                <?= $userData['status'] === 'active' ? 'checked' : '' ?>>
            <label class="form-check-label" for="active">aktiv</label>
        </div>
        <div class="form-check">
            <input class="form-check-input" type="radio" name="status" id="inactive" value="inactive"
                <?= $userData['status'] === 'inactive' ? 'checked' : '' ?>>

        ...
        <nav
            ...
            <div class="container-fluid flex-lg-column align-items-stretch">
                ...
                <div class="d-flex w-100 justify-content-between align-items-center">
                    <a class="navbar-brand d-flex align-items-center text-white gap-2" href="<?= page_url('admin_dashboard')?>">
                ...
                <div class="collapse navbar-collapse w-100 mt-3" id="sidebarMenu">
                    <ul class="navbar-nav flex-column w-100">
                        <li class="nav-item"><a class="nav-link text-white"
                                href="<?= page_url('admin_dashboard')?>">Übersicht</a></li>
                        <li class="nav-item"><a class="nav-link text-white" href="<?= page_url('user_management')?>">Benutzerverwaltung</a></li>
                    </ul>
                </div>
            </div>
        </nav>
